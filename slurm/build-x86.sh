#!/bin/bash
# Build a single package inside the CUDA 13.0 Docker container.
# Usage: sbatch --export=PACKAGE=flash-attn,VERSION=2.7.4.post1 slurm/build-x86.sh
#
...
echo "=== [$(date)] Building ${PACKAGE}==${VERSION} py${PYTHON_VERSION} torch${TORCH_VERSION} cu13.0 ==="
